...
//
//
// Related Topics 位运算 数组 回溯 枚举 矩阵 👍 49 👎 0
...
func maximumRows(matrix [][]int, numSelect int) int {
	...
	//	return
	//}
	//var dfs func(v, idx, cnt int) int
	//dfs = func(v, idx, cnt int) int {
	//	if cnt < 0 {
	//		return -1
	//	}
	//	if idx < 0 {
	//		return get(v)
	//	}
	//	return max(dfs(v, idx-1, cnt), dfs(v|(1<<idx), idx-1, cnt-1))
	//}
	//return dfs(0, len(matrix[0])-1, numSelect)
}
